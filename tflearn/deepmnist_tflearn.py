...
network = conv_2d(
    input, nb_filter=32, filter_size=3, activation="relu", regularizer="L2")
network = max_pool_2d(network, 2)

network = conv_2d(
    network, nb_filter=64, filter_size=3, activation="relu", regularizer="L2")
network = max_pool_2d(network, 2)
